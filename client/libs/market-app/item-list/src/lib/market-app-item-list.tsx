...
export interface MarketAppItemListProps {}

export function MarketAppItemList(props: MarketAppItemListProps) {
  return (
    <div className="bg-white lg:ml-2 w-full lg:w-6/12">
      <div className="mx-auto py-5 sm:px-6 lg:px-4">
...
export default MarketAppItemList;
