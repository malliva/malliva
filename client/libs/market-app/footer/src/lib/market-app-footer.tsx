...
import './market-app-footer.module.scss';
...
export interface MarketAppFooterProps {}

export function MarketAppFooter(props: MarketAppFooterProps) {
  return (
    <footer className="bg-white" aria-labelledby="footerHeading">
      ...
      <div className="mx-auto py-12">
        <div className="border-t p-4 border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
        ...
        <div className="mt-8 border-t px-4 border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="space-x-0 md:order-2">
            ...
            <div className="mt-8 ml-0 text-base text-gray-400 md:mt-10 md:order-1">
              &copy; Powered by Malliva.
            </div>
          </div>
...
export default MarketAppFooter;
